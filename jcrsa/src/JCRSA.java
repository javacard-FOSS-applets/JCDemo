package com.jcdemo.jcrsa;

import javacard.framework.*;
import javacardx.crypto.*;
import javacard.security.*;

public class JCRSA extends Applet {
  // RSA1024 
  ...
  // APDU Command INS
  public static final byte INS_GEN_RSA_KEY_1024   = (byte)0x01;
  public static final byte INS_GEN_RSA_KEY_2048   = (byte)0x02;

  // INS Table
  public static final byte[] insTable = {
    // cla ins pp1 pp2 pp3 ctrl
    // ctrl -> bit8 :  1 = APDU hava receive data; 0 = no receive data
    (byte)0x00, INS_GEN_RSA_KEY_1024  , (byte)0xFF, (byte)0xFF, (byte)0xFF, (byte)0x00,
    (byte)0x00, INS_GEN_RSA_KEY_2048  , (byte)0xFF, (byte)0xFF, (byte)0xFF, (byte)0x00,
    (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00
  };

  /**
   * @brief JCRSA Construct function
   *
   * @param bArray
   * @param bOffset
   * @param bLength
   ...
   * @return 
   */
  protected JCRSA(byte[] bArray, short bOffset, byte bLength) {
    rsaKeyPair1024 = new KeyPair(KeyPair.ALG_RSA_CRT, KeyBuilder.LENGTH_RSA_1024);
    rsaPubKey1024 = (RSAPublicKey)(rsaKeyPair1024.getPublic());
    rsaPriCrtKey1024 = (RSAPrivateCrtKey)(rsaKeyPair1024.getPrivate());

    rsaKeyPair2048 = new KeyPair(KeyPair.ALG_RSA_CRT, KeyBuilder.LENGTH_RSA_2048);
    rsaPubKey2048 = (RSAPublicKey)(rsaKeyPair2048.getPublic());
    rsaPriCrtKey2048 = (RSAPrivateCrtKey)(rsaKeyPair2048.getPrivate());

    RSACiper = Cipher.getInstance(Cipher.ALG_RSA_NOPAD, false);

    comBuffer = JCSystem.makeTransientByteArray((short)0x0400, JCSystem.CLEAR_ON_DESELECT);
  ...
  public void process(APDU apdu) {
    try {
      ...
      // handle APDU
      switch(ins) {
        case INS_GEN_RSA_KEY_1024:
          // 1 geneate RSA 1024  
          rsaKeyPair1024.genKeyPair();
          len1 = genRSAPublicKey(comBuffer, (short)0, rsaPubKey1024);
          len2 = genRSAPrivateKey(comBuffer, (short)len1, rsaPriCrtKey1024);
          Util.arrayCopyNonAtomic(comBuffer, (short)0, apduBuffer, (short)(ISO7816.OFFSET_CDATA), (short)(len1));
          setOutgoingAndSend(apdu, (short)ISO7816.OFFSET_CDATA, (short)(len1));
          break;
        case INS_GEN_RSA_KEY_2048:
          // 1 geneate RSA 2048 
          rsaKeyPair2048.genKeyPair();
          len1 = genRSAPublicKey(comBuffer, (short)0, rsaPubKey2048);
          len2 = genRSAPrivateKey(comBuffer, (short)len1, rsaPriCrtKey2048);
          Util.arrayCopyNonAtomic(comBuffer, (short)2, apduBuffer, (short)(0), (short)(0x100));
          setOutgoingAndSend(apdu, (short)0, (short)(0x100));
          break;
        default:
